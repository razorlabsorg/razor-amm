...
export class AptosContractWrapperBaseClass {
  ...
  public async fundAccount(account: AccountAddress, amount: bigint): Promise<UserTransactionResponse> {
  ...
  public async getTxEvents(txHash: HexInput): Promise<Array<{ data: any }>> {
