...
export class PackagePublisher {
  private static readonly MAX_TRANSACTION_SIZE: number = 60000;

  private readonly aptosProvider: AptosProvider;

  private readonly senderAccount: Account;

  private packagePath: fs.PathOrFileDescriptor;

  private readonly largePackagesClient: LargePackagesClient;
